        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrderLineItem_DeliveredQty", "[DeliveredQuantity] <= [OrderedQuantity]");
                    table.CheckConstraint("CK_OrderLineItem_ReturnedQty", "[ReturnedQuantity] <= [DeliveredQuantity]");
                    table.ForeignKey(
